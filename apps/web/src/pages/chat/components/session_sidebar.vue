      ...
      <SidebarProvider>
        <SidebarInset>
          ...
          >
            ...
            <Separator />
            <SidebarContent class="py-4 px-3">
              <SidebarMenu>
                <form class="**:[label]:text-xs **:[label]:uppercase **:[label]:text-muted-foreground **:[label]:tracking-wide ">
                  <section class="flex flex-col gap-6">
                    ...
                    <section>
                      ...
                      <Card class="p-4!">
                        <CardContent class="p-0 flex flex-col **:[section]:text-xs gap-3 text-muted-foreground *:flex *:justify-between ">
                          <section>
                            <h5>输入Token</h5>
                            <data>4,281</data>
                          </section>
