            ...
            <div class="p-2 shrink-0">
                <InputGroup class="h-[30px]">
                    <InputGroupAddon class="pl-2.5">
                        <Search class="size-[11px] text-muted-foreground" />
                    </InputGroupAddon>
                    <InputGroupInput
                        v-model="searchQuery"
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger as-child>
                        <button class="flex items-center gap-1">
                            ...
                            />
                            <span
                                class="text-[10px] font-medium text-muted-foreground uppercase tracking-[0.7px]"
                            >
                                {{ t('chat.sessionSourcePrefix')
                                }}{{ filterLabel }}
                            </span>
                            <ChevronDown
...
const { sessions, sessionId, currentBotId, loadingChats } =
