...
import PanelProjectDoc from './dockview/panel-project-doc.vue'
import PanelProjectKanban from './dockview/panel-project-kanban.vue'
import PanelProjectIssue from './dockview/panel-project-issue.vue'
...
const panelComponents: Record<string, VueComponent> = {
  ...
  projectDoc: PanelProjectDoc as unknown as VueComponent,
  projectKanban: PanelProjectKanban as unknown as VueComponent,
  projectIssue: PanelProjectIssue as unknown as VueComponent,
}
