...
EVIDENCE_FILE="${1:-}"
EXPECTED_RUNTIME="${MEMOH_CONTAINERD_SMOKE_EVIDENCE_EXPECTED_RUNTIME:-io.containerd.kata.v2}"
EXPECTED_NAMESPACE="${MEMOH_CONTAINERD_SMOKE_EVIDENCE_EXPECTED_NAMESPACE:-default}"
EXPECTED_IMAGE="${MEMOH_CONTAINERD_SMOKE_EVIDENCE_EXPECTED_IMAGE:-docker.io/library/alpine:3.22}"
EXPECTED_SNAPSHOTTER="${MEMOH_CONTAINERD_SMOKE_EVIDENCE_EXPECTED_SNAPSHOTTER:-overlayfs}"
