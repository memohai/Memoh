...
│   ├── ui/                     #   Shared UI component library (@felinic/ui) — git submodule → github.com/memohai/ui; also owns the web / ui-owners agent skills (loaded through cross-platform wrappers in .agents/skills/)
