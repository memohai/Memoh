...
func TestSQLCExecutorConstructsParamsForKnownQueries(t *testing.T) {
	...
	sample := SessionSeed{
		...
		ExternalMessageIDs:  []string{"external-message"},
		ApprovalToolCallID:  "tool-call",
		ApprovalTurnID:      uuid.New(),
		ApprovalRequestID:   uuid.New(),
		ApprovalBaseReqID:   uuid.New(),
		ApprovalShortID:     1,
		ApprovalPromptID:    "approval-prompt",
		UserInputToolCallID: "ask-user",
		UserInputTurnID:     uuid.New(),
