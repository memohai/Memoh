...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/project.SearchResult"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/project.LabelRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/project.CreateNodeRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/project.NodeDetail"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/projects/{project_id}/nodes/{node_id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Content patch",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/project.UpdateContentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/projects/{project_id}/nodes/{node_id}/activity": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/project.Activity"
                            }
                        }
                    },
                    "404": {
        ...
        "/projects/{project_id}/nodes/{node_id}/comments": {
            "get": {
                "produces": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/project.Comment"
                            }
                        }
                    },
                    "404": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/project.CommentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/projects/{project_id}/nodes/{node_id}/comments/{comment_id}": {
            "delete": {
        ...
        "/projects/{project_id}/nodes/{node_id}/issue": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Issue patch",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/project.UpdateIssueRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/project.IssueDetails"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/projects/{project_id}/nodes/{node_id}/labels": {
            "put": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/project.SetNodeLabelsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/projects/{project_id}/nodes/{node_id}/links": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/project.LinkRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/projects/{project_id}/nodes/{node_id}/links/{target_node_id}": {
            "delete": {
                "tags": [
                    "projects"
                ],
        ...
        "/projects/{project_id}/nodes/{node_id}/move": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/project.MoveNodeRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/projects/{project_id}/nodes/{node_id}/versions": {
            "get": {
                "produces": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/project.VersionMeta"
                            }
                        }
                    },
                    "404": {
        ...
        "/projects/{project_id}/nodes/{node_id}/versions/{version}": {
            "get": {
                "produces": [
                    "application/json"
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/project.TreeNode"
                            }
                        }
                    },
                    "404": {
    ...
    "definitions": {
        ...
        "project.NodeDetail": {
            ...
            "properties": {
                ...
                "links": {
                    "$ref": "#/definitions/project.NodeLinks"
                },
                "node": {
                    "$ref": "#/definitions/project.Node"
                }
        ...
        "project.NodeLinks": {
            ...
            "properties": {
                "incoming": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/project.LinkedNode"
                    }
                },
                "outgoing": {
                    "type": "array",
