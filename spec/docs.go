                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/memoryproviders.GetResponse"
                            }
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/memoryproviders.CreateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/memoryproviders.ProviderMeta"
                            }
                        }
                    }
                }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/memoryproviders.UpdateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "memoryproviders.CreateRequest": {
            ...
            "properties": {
                ...
                "provider": {
                    "$ref": "#/definitions/memoryproviders.ProviderType"
                }
            }
        },
        "memoryproviders.GetResponse": {
            "type": "object",
            "properties": {
                "config": {
                    "type": "object",
        ...
        "memoryproviders.ProviderConfigSchema": {
            "type": "object",
            "properties": {
                "fields": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/memoryproviders.ProviderFieldSchema"
                    }
                }
            }
        },
        "memoryproviders.ProviderFieldSchema": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "memoryproviders.ProviderMeta": {
            "type": "object",
            "properties": {
                "config_schema": {
                    "$ref": "#/definitions/memoryproviders.ProviderConfigSchema"
                },
                "display_name": {
                    "type": "string"
                },
