...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/bots/{bot_id}/runtime-diagnostics": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/runtimediagnostics.Response"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
    ...
    "definitions": {
        ...
        "runtimediagnostics.ACPAgentDiagnostic": {
            "type": "object",
            "properties": {
                "agent_id": {
                    "type": "string"
                ...
                "auth": {
                    "$ref": "#/definitions/runtimediagnostics.ACPAuthDiagnostic"
                },
                "cli": {
                    "$ref": "#/definitions/runtimediagnostics.ACPCLIDiagnostic"
                },
                "code": {
                    "type": "string"
                },
                ...
                "last_error": {
                    "$ref": "#/definitions/runtimediagnostics.RuntimeEventSummary"
                },
                "model": {
                    "$ref": "#/definitions/runtimediagnostics.ACPModelDiagnostic"
                },
                "next_action": {
                    "type": "string"
                },
                "profile": {
                    "$ref": "#/definitions/runtimediagnostics.ACPProfileDiagnostic"
                },
                "session_resume": {
                    "$ref": "#/definitions/runtimediagnostics.ACPSessionResumeDiagnostic"
                },
                "setup_mode": {
                    "type": "string"
                },
                "state": {
                    "$ref": "#/definitions/runtimediagnostics.State"
                },
                "workspace_backend": {
                    "type": "string"
                }
        ...
        "runtimediagnostics.ACPAuthDiagnostic": {
            "type": "object",
            "properties": {
                "api_key_present": {
                    "type": "boolean"
        ...
        "runtimediagnostics.ACPCLIDiagnostic": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "boolean"
        ...
        "runtimediagnostics.ACPModelDiagnostic": {
            "type": "object",
            "properties": {
                "available_models": {
                    "type": "array",
                ...
                "state": {
                    "$ref": "#/definitions/runtimediagnostics.ACPModelState"
                }
            }
        },
        "runtimediagnostics.ACPModelState": {
            "type": "string",
            "enum": [
                "known",
                "unknown",
                "unsupported",
                "unknown_until_runtime_start"
            ],
            "x-enum-varnames": [
                "ACPModelStateKnown",
                "ACPModelStateUnknown",
                "ACPModelStateUnsupported",
                "ACPModelStateUnknownUntilRuntimeStart"
            ]
        },
        "runtimediagnostics.ACPProfileDiagnostic": {
            "type": "object",
            "properties": {
                "backend_supported": {
                    "type": "boolean"
        ...
        "runtimediagnostics.ACPSessionResumeDiagnostic": {
            "type": "object",
            "properties": {
                "acp_session_id": {
                    "type": "string"
                ...
                "state": {
                    "$ref": "#/definitions/runtimediagnostics.ACPSessionResumeState"
                }
            }
        },
        "runtimediagnostics.ACPSessionResumeState": {
            "type": "string",
            "enum": [
                "warm_resumable",
                "cold_start_required",
            ...
            "x-enum-varnames": [
                "ACPSessionResumeStateWarmResumable",
                "ACPSessionResumeStateColdStartRequired",
                "ACPSessionResumeStateNoACPSession",
                "ACPSessionResumeStateDisabled",
                "ACPSessionResumeStateBlocked"
            ]
        },
        "runtimediagnostics.ContainerDiagnostic": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "runtimediagnostics.DisplayDiagnostic": {
            "type": "object",
            "properties": {
                "a11y_available": {
                    "type": "boolean"
        ...
        "runtimediagnostics.Response": {
            "type": "object",
            "properties": {
                "acp_agents": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/runtimediagnostics.ACPAgentDiagnostic"
                    }
                },
                "checked_at": {
                    "type": "string"
                ...
                "container": {
                    "$ref": "#/definitions/runtimediagnostics.ContainerDiagnostic"
                },
                "display": {
                    "$ref": "#/definitions/runtimediagnostics.DisplayDiagnostic"
                },
                "overall_state": {
                    "$ref": "#/definitions/runtimediagnostics.State"
                },
                ...
                "workspace": {
                    "$ref": "#/definitions/runtimediagnostics.WorkspaceDiagnostic"
                }
            }
        },
        "runtimediagnostics.RuntimeEventSummary": {
            "type": "object",
            "properties": {
                "agent_id": {
                    "type": "string"
        ...
        "runtimediagnostics.WorkspaceDiagnostic": {
            "type": "object",
            "properties": {
                "backend": {
                    "type": "string"
