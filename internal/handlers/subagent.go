...
// SubagentHandler serves /bots/:bot_id/subagents CRUD and context/skills APIs.
...
// NewSubagentHandler creates a subagent handler.
...
// Register mounts /bots/:bot_id/subagents routes on the Echo instance.
