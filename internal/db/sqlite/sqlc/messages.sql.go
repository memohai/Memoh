...
type GetSessionTurnAncestorMatchParams struct {
	AncestorTurnID string `json:"ancestor_turn_id"`
...
func (q *Queries) GetSessionTurnAncestorMatch(ctx context.Context, arg GetSessionTurnAncestorMatchParams) (string, error) {
	row := q.db.QueryRowContext(ctx, getSessionTurnAncestorMatch, arg.AncestorTurnID, arg.TurnID)
	var id string
	err := row.Scan(&id)
	return id, err
}
...
func (q *Queries) ListSessionTurnPathIDs(ctx context.Context, headTurnID string) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, listSessionTurnPathIDs, headTurnID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
// recursion runs.
func (q *Queries) ResolveSessionTurnHead(ctx context.Context, arg ResolveSessionTurnHeadParams) (string, error) {
	row := q.db.QueryRowContext(ctx, resolveSessionTurnHead, arg.SessionID, arg.TargetTurnID)
	var head_turn_id string
