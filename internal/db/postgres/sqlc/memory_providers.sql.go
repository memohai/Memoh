...
SELECT id, name, provider, config, is_default, created_at, updated_at, team_id FROM memory_providers WHERE team_id = app.current_team_id() AND is_default = true LIMIT 1
`
...
SELECT id, name, provider, config, is_default, created_at, updated_at, team_id FROM memory_providers WHERE team_id = app.current_team_id() AND id = $1
`
...
SELECT id, name, provider, config, is_default, created_at, updated_at, team_id FROM memory_providers WHERE team_id = app.current_team_id() ORDER BY created_at ASC
`
