...
RETURNING id, model_uuid, variant_id, weight, metadata, created_at, updated_at, tenant_id
`
...
SELECT
  m.id, m.model_id, m.name, m.provider_id, m.type, m.enable, m.config, m.created_at, m.updated_at, m.tenant_id,
