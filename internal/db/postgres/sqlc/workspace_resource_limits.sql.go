...
SELECT bot_id, cpu_millicores, memory_bytes, storage_bytes, created_at, updated_at, team_id FROM bot_workspace_resource_limits WHERE team_id = app.current_team_id() AND bot_id = $1
`
