...
SELECT id, provider_id, bot_id, message_id, from_address, to_addresses, subject, body_text, body_html, attachments, status, error, sent_at, created_at, team_id FROM email_outbox WHERE team_id = app.current_team_id() AND id = $1
`
