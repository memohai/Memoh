...
type Queries interface {
	...
	MarkUserInputPromptDelivered(ctx context.Context, id pgtype.UUID) (dbsqlc.UserInputRequest, error)
	...
	GetSessionDiscussEventCursorFloor(ctx context.Context, sessionID pgtype.UUID) (int64, error)
	...
	ListExternalMessagePositionsBySession(ctx context.Context, arg dbsqlc.ListExternalMessagePositionsBySessionParams) ([]dbsqlc.ListExternalMessagePositionsBySessionRow, error)
