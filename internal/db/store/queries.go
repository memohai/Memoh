...
type Queries interface {
	...
	FinalizeCompactionRollup(ctx context.Context, arg dbsqlc.FinalizeCompactionRollupParams) (dbsqlc.FinalizeCompactionRollupRow, error)
	...
	GetLatestActiveTurnResponseAtBySession(ctx context.Context, sessionID pgtype.UUID) (pgtype.Timestamptz, error)
	...
	ListCompactionArtifactLineageMetadataBySession(ctx context.Context, sessionID pgtype.UUID) ([]dbsqlc.ListCompactionArtifactLineageMetadataBySessionRow, error)
	...
	ListCompactionArtifactPayloadsByIDs(ctx context.Context, ids []pgtype.UUID) ([]dbsqlc.BotHistoryMessageCompact, error)
