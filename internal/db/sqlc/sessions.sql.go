...
RETURNING id, bot_id, route_id, channel_type, title, metadata, created_at, updated_at, deleted_at
`
...
SELECT s.id, s.bot_id, s.route_id, s.channel_type, s.title, s.metadata, s.created_at, s.updated_at, s.deleted_at
FROM bot_sessions s
