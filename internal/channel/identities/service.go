// Package identities provides channel identity resolution and linking.
package identities
...
// ErrChannelIdentityNotFound is returned when no channel identity exists for the given id or criteria.
