...
/**
 * Install bot plugin from manifest
 */
export const postBotsByBotIdPluginsMutation = (options?: Partial<Options<PostBotsByBotIdPluginsData>>): UseMutationOptions<PostBotsByBotIdPluginsResponse, Options<PostBotsByBotIdPluginsData>, PostBotsByBotIdPluginsError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdPlugins({
            ...options,
            ...vars,
            throwOnError: true
        });
