...
/**
 * Remove a Bot's Remote Runtime workspace binding
 *
 * Stops routing new workspace calls to the Remote Runtime. Remote files are not deleted.
 */
export const deleteBotsByBotIdRemoteRuntimeMutation = (options?: Partial<Options<DeleteBotsByBotIdRemoteRuntimeData>>): UseMutationOptions<unknown, Options<DeleteBotsByBotIdRemoteRuntimeData>, DeleteBotsByBotIdRemoteRuntimeError> => ({
    mutation: async (vars) => {
        const { data } = await deleteBotsByBotIdRemoteRuntime({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getBotsByBotIdRemoteRuntimeQueryKey = (options: Options<GetBotsByBotIdRemoteRuntimeData>) => createQueryKey('getBotsByBotIdRemoteRuntime', options);

/**
 * Get a Bot's Remote Runtime workspace binding
 */
export const getBotsByBotIdRemoteRuntimeQuery = defineQueryOptions<Options<GetBotsByBotIdRemoteRuntimeData>, GetBotsByBotIdRemoteRuntimeResponse, GetBotsByBotIdRemoteRuntimeError>((options: Options<GetBotsByBotIdRemoteRuntimeData>) => ({
    key: getBotsByBotIdRemoteRuntimeQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByBotIdRemoteRuntime({
            ...options,
            ...context,
            throwOnError: true
        });
...
/**
 * Bind a Bot workspace to a Remote Runtime
 *
 * Route the Bot's persistent workspace through a user-owned Remote Runtime. An omitted workspace_path uses bots/{bot_id}; multiple Bots may explicitly share the same path.
 */
export const putBotsByBotIdRemoteRuntimeMutation = (options?: Partial<Options<PutBotsByBotIdRemoteRuntimeData>>): UseMutationOptions<PutBotsByBotIdRemoteRuntimeResponse, Options<PutBotsByBotIdRemoteRuntimeData>, PutBotsByBotIdRemoteRuntimeError> => ({
    mutation: async (vars) => {
