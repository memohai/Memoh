...
export const getBotsByBotIdSessionsBySessionIdInfoQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdInfoData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdInfo', options);
 ...
 */
export const getBotsByBotIdSessionsBySessionIdInfoQuery = defineQueryOptions((options: Options<GetBotsByBotIdSessionsBySessionIdInfoData>) => ({
    key: getBotsByBotIdSessionsBySessionIdInfoQueryKey(options),
    query: async (context) => {
