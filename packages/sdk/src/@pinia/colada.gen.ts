...
export const getBotsByBotIdSessionsBySessionIdRuntimeQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdRuntimeData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdRuntime', options);

/**
 * Get session runtime state
 *
 * Returns the current live runtime snapshot for a chat session.
 */
export const getBotsByBotIdSessionsBySessionIdRuntimeQuery = defineQueryOptions<Options<GetBotsByBotIdSessionsBySessionIdRuntimeData>, GetBotsByBotIdSessionsBySessionIdRuntimeResponse, GetBotsByBotIdSessionsBySessionIdRuntimeError>((options: Options<GetBotsByBotIdSessionsBySessionIdRuntimeData>) => ({
    key: getBotsByBotIdSessionsBySessionIdRuntimeQueryKey(options),
    query: async (context) => {
