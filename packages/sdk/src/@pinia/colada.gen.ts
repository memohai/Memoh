 ...
 */
export const postBotsByBotIdAcpAgentsByAgentIdCredentialsTestMutation = (options?: Partial<Options<PostBotsByBotIdAcpAgentsByAgentIdCredentialsTestData>>): UseMutationOptions<PostBotsByBotIdAcpAgentsByAgentIdCredentialsTestResponse, Options<PostBotsByBotIdAcpAgentsByAgentIdCredentialsTestData>, PostBotsByBotIdAcpAgentsByAgentIdCredentialsTestError> => ({
    mutation: async (vars) => {
