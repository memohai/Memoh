...
/**
 * Cancel WhatsApp pairing
 *
 * Cancels an in-progress experimental WhatsApp Web QR or phone pairing flow.
 */
export const postBotsByIdChannelWhatsappLoginCancelMutation = (options?: Partial<Options<PostBotsByIdChannelWhatsappLoginCancelData>>): UseMutationOptions<PostBotsByIdChannelWhatsappLoginCancelResponse, Options<PostBotsByIdChannelWhatsappLoginCancelData>, PostBotsByIdChannelWhatsappLoginCancelError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByIdChannelWhatsappLoginCancel({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 *
 * Unlinks the WhatsApp Web session when possible, stops runtime connection, deletes local store, and removes channel config.
 */
export const postBotsByIdChannelWhatsappLogoutMutation = (options?: Partial<Options<PostBotsByIdChannelWhatsappLogoutData>>): UseMutationOptions<PostBotsByIdChannelWhatsappLogoutResponse, Options<PostBotsByIdChannelWhatsappLogoutData>, PostBotsByIdChannelWhatsappLogoutError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByIdChannelWhatsappLogout({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Poll WhatsApp phone pairing
 *
 * Polls a WhatsApp phone pairing flow and finalizes the bot channel when pairing succeeds.
 */
export const postBotsByIdChannelWhatsappPhonePollMutation = (options?: Partial<Options<PostBotsByIdChannelWhatsappPhonePollData>>): UseMutationOptions<PostBotsByIdChannelWhatsappPhonePollResponse, Options<PostBotsByIdChannelWhatsappPhonePollData>, PostBotsByIdChannelWhatsappPhonePollError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByIdChannelWhatsappPhonePoll({
            ...options,
            ...vars,
            throwOnError: true
        });
...
/**
 * Start WhatsApp phone pairing
 *
 * Starts an experimental WhatsApp Web phone pairing flow and returns a pairing code to enter on the phone.
 */
export const postBotsByIdChannelWhatsappPhoneStartMutation = (options?: Partial<Options<PostBotsByIdChannelWhatsappPhoneStartData>>): UseMutationOptions<PostBotsByIdChannelWhatsappPhoneStartResponse, Options<PostBotsByIdChannelWhatsappPhoneStartData>, PostBotsByIdChannelWhatsappPhoneStartError> => ({
    mutation: async (vars) => {
...
/**
 * Poll WhatsApp QR login
 *
 * Polls a WhatsApp QR pairing flow and finalizes the bot channel when pairing succeeds.
 */
export const postBotsByIdChannelWhatsappQrPollMutation = (options?: Partial<Options<PostBotsByIdChannelWhatsappQrPollData>>): UseMutationOptions<PostBotsByIdChannelWhatsappQrPollResponse, Options<PostBotsByIdChannelWhatsappQrPollData>, PostBotsByIdChannelWhatsappQrPollError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByIdChannelWhatsappQrPoll({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 *
 * Starts an experimental WhatsApp Web QR pairing flow for a bot channel.
 */
export const postBotsByIdChannelWhatsappQrStartMutation = (options?: Partial<Options<PostBotsByIdChannelWhatsappQrStartData>>): UseMutationOptions<PostBotsByIdChannelWhatsappQrStartResponse, Options<PostBotsByIdChannelWhatsappQrStartData>, PostBotsByIdChannelWhatsappQrStartError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByIdChannelWhatsappQrStart({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getBotsByIdChannelWhatsappStatusQueryKey = (options: Options<GetBotsByIdChannelWhatsappStatusData>) => createQueryKey('getBotsByIdChannelWhatsappStatus', options);

/**
 * Get WhatsApp channel status
 *
 * Gets the persisted and runtime status for the bot's experimental WhatsApp channel.
 */
export const getBotsByIdChannelWhatsappStatusQuery = defineQueryOptions((options: Options<GetBotsByIdChannelWhatsappStatusData>) => ({
    key: getBotsByIdChannelWhatsappStatusQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByIdChannelWhatsappStatus({
            ...options,
            ...context,
            throwOnError: true
        });
