...
export const getAvatarsByContentHashQueryKey = (options: Options<GetAvatarsByContentHashData>) => createQueryKey('getAvatarsByContentHash', options);
 ...
 */
export const getAvatarsByContentHashQuery = defineQueryOptions<Options<GetAvatarsByContentHashData>, unknown, GetAvatarsByContentHashError>((options: Options<GetAvatarsByContentHashData>) => ({
    key: getAvatarsByContentHashQueryKey(options),
    query: async (context) => {
        const { data } = await getAvatarsByContentHash({
            ...options,
            ...context,
            throwOnError: true
        });
