...
/**
 * Update bot plugin configuration
 */
export const putBotsByBotIdPluginsByIdConfigMutation = (options?: Partial<Options<PutBotsByBotIdPluginsByIdConfigData>>): UseMutationOptions<PutBotsByBotIdPluginsByIdConfigResponse, Options<PutBotsByBotIdPluginsByIdConfigData>, PutBotsByBotIdPluginsByIdConfigError> => ({
    mutation: async (vars) => {
 ...
 */
export const postBotsByBotIdPluginsByIdUninstallMutation = (options?: Partial<Options<PostBotsByBotIdPluginsByIdUninstallData>>): UseMutationOptions<unknown, Options<PostBotsByBotIdPluginsByIdUninstallData>, PostBotsByBotIdPluginsByIdUninstallError> => ({
    mutation: async (vars) => {
