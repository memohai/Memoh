...
export const getBotsByBotIdRuntimeDiagnosticsQueryKey = (options: Options<GetBotsByBotIdRuntimeDiagnosticsData>) => createQueryKey('getBotsByBotIdRuntimeDiagnostics', options);

/**
 * Get bot runtime diagnostics
 *
 * Returns read-only ACP, workspace, container, and display runtime diagnostics for a bot.
 */
export const getBotsByBotIdRuntimeDiagnosticsQuery = defineQueryOptions((options: Options<GetBotsByBotIdRuntimeDiagnosticsData>) => ({
    key: getBotsByBotIdRuntimeDiagnosticsQueryKey(options),
    query: async (context) => {
