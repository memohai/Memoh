...
export const getBotsByBotIdSessionsBySessionIdBranchesQueryKey = (options: Options<GetBotsByBotIdSessionsBySessionIdBranchesData>) => createQueryKey('getBotsByBotIdSessionsBySessionIdBranches', options);

/**
 * List session branches
 */
export const getBotsByBotIdSessionsBySessionIdBranchesQuery = defineQueryOptions((options: Options<GetBotsByBotIdSessionsBySessionIdBranchesData>) => ({
    key: getBotsByBotIdSessionsBySessionIdBranchesQueryKey(options),
    query: async (context) => {
 ...
 */
export const patchBotsByBotIdSessionsBySessionIdBranchesActiveMutation = (options?: Partial<Options<PatchBotsByBotIdSessionsBySessionIdBranchesActiveData>>): UseMutationOptions<PatchBotsByBotIdSessionsBySessionIdBranchesActiveResponse, Options<PatchBotsByBotIdSessionsBySessionIdBranchesActiveData>, PatchBotsByBotIdSessionsBySessionIdBranchesActiveError> => ({
    mutation: async (vars) => {
