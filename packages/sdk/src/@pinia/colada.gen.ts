...
export const getBotsByBotIdContainerDisplayWsQueryKey = (options: Options<GetBotsByBotIdContainerDisplayWsData>) => createQueryKey('getBotsByBotIdContainerDisplayWs', options);

/**
 * WebSocket VNC relay for bot workspace display
 */
export const getBotsByBotIdContainerDisplayWsQuery = defineQueryOptions((options: Options<GetBotsByBotIdContainerDisplayWsData>) => ({
    key: getBotsByBotIdContainerDisplayWsQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByBotIdContainerDisplayWs({
            ...options,
            ...context,
            throwOnError: true
        });
