 ...
 */
export const getBotsByBotIdSessionsBySessionIdBranches = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdSessionsBySessionIdBranchesData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdSessionsBySessionIdBranchesResponses, GetBotsByBotIdSessionsBySessionIdBranchesErrors, ThrowOnError>({ url: '/bots/{bot_id}/sessions/{session_id}/branches', ...options });

/**
 * Switch the active session branch
 */
export const patchBotsByBotIdSessionsBySessionIdBranchesActive = <ThrowOnError extends boolean = false>(options: Options<PatchBotsByBotIdSessionsBySessionIdBranchesActiveData, ThrowOnError>) => (options.client ?? client).patch<PatchBotsByBotIdSessionsBySessionIdBranchesActiveResponses, PatchBotsByBotIdSessionsBySessionIdBranchesActiveErrors, ThrowOnError>({
