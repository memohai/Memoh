 ...
 */
export const getBotsByBotIdContainerDisplayWs = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdContainerDisplayWsData, ThrowOnError>) => (options.client ?? client).get<unknown, GetBotsByBotIdContainerDisplayWsErrors, ThrowOnError>({ url: '/bots/{bot_id}/container/display/ws', ...options });
