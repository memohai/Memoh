 ...
 */
export const postBotsByIdChannelWhatsappLoginCancel = <ThrowOnError extends boolean = false>(options: Options<PostBotsByIdChannelWhatsappLoginCancelData, ThrowOnError>) => (options.client ?? client).post<PostBotsByIdChannelWhatsappLoginCancelResponses, PostBotsByIdChannelWhatsappLoginCancelErrors, ThrowOnError>({
 ...
 */
export const postBotsByIdChannelWhatsappLogout = <ThrowOnError extends boolean = false>(options: Options<PostBotsByIdChannelWhatsappLogoutData, ThrowOnError>) => (options.client ?? client).post<PostBotsByIdChannelWhatsappLogoutResponses, PostBotsByIdChannelWhatsappLogoutErrors, ThrowOnError>({ url: '/bots/{id}/channel/whatsapp/logout', ...options });
 ...
 */
export const postBotsByIdChannelWhatsappPhonePoll = <ThrowOnError extends boolean = false>(options: Options<PostBotsByIdChannelWhatsappPhonePollData, ThrowOnError>) => (options.client ?? client).post<PostBotsByIdChannelWhatsappPhonePollResponses, PostBotsByIdChannelWhatsappPhonePollErrors, ThrowOnError>({
 ...
 */
export const postBotsByIdChannelWhatsappPhoneStart = <ThrowOnError extends boolean = false>(options: Options<PostBotsByIdChannelWhatsappPhoneStartData, ThrowOnError>) => (options.client ?? client).post<PostBotsByIdChannelWhatsappPhoneStartResponses, PostBotsByIdChannelWhatsappPhoneStartErrors, ThrowOnError>({
 ...
 */
export const postBotsByIdChannelWhatsappQrPoll = <ThrowOnError extends boolean = false>(options: Options<PostBotsByIdChannelWhatsappQrPollData, ThrowOnError>) => (options.client ?? client).post<PostBotsByIdChannelWhatsappQrPollResponses, PostBotsByIdChannelWhatsappQrPollErrors, ThrowOnError>({
 ...
 */
export const postBotsByIdChannelWhatsappQrStart = <ThrowOnError extends boolean = false>(options: Options<PostBotsByIdChannelWhatsappQrStartData, ThrowOnError>) => (options.client ?? client).post<PostBotsByIdChannelWhatsappQrStartResponses, PostBotsByIdChannelWhatsappQrStartErrors, ThrowOnError>({ url: '/bots/{id}/channel/whatsapp/qr/start', ...options });
 ...
 */
export const getBotsByIdChannelWhatsappStatus = <ThrowOnError extends boolean = false>(options: Options<GetBotsByIdChannelWhatsappStatusData, ThrowOnError>) => (options.client ?? client).get<GetBotsByIdChannelWhatsappStatusResponses, GetBotsByIdChannelWhatsappStatusErrors, ThrowOnError>({ url: '/bots/{id}/channel/whatsapp/status', ...options });
