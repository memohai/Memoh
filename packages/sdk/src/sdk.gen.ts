 ...
 */
export const putBotsByBotIdPluginsByIdConfig = <ThrowOnError extends boolean = false>(options: Options<PutBotsByBotIdPluginsByIdConfigData, ThrowOnError>) => (options.client ?? client).put<PutBotsByBotIdPluginsByIdConfigResponses, PutBotsByBotIdPluginsByIdConfigErrors, ThrowOnError>({
