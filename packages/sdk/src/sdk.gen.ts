 ...
 */
export const postBotsByBotIdPlugins = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdPluginsData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdPluginsResponses, PostBotsByBotIdPluginsErrors, ThrowOnError>({
