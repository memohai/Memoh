 ...
 */
export const getBotsByBotIdRuntimeDiagnostics = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdRuntimeDiagnosticsData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdRuntimeDiagnosticsResponses, GetBotsByBotIdRuntimeDiagnosticsErrors, ThrowOnError>({ url: '/bots/{bot_id}/runtime-diagnostics', ...options });
