 ...
 */
export const postTtsProvidersByIdTest = <ThrowOnError extends boolean = false>(options: Options<PostTtsProvidersByIdTestData, ThrowOnError>) => (options.client ?? client).post<PostTtsProvidersByIdTestResponses, PostTtsProvidersByIdTestErrors, ThrowOnError>({
