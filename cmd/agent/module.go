...
func options() fx.Option {
	return fx.Options(
		fx.Provide(
			...
			provideRuntimeDiagnosticsService,
			...
			provideServerHandler(handlers.NewRuntimeDiagnosticsHandler),
		...
		fx.Invoke(
			...
			injectRuntimeDiagnosticsRecorder,
			startRuntimeDiagnosticsHousekeeper,
			startRegistrySync,
