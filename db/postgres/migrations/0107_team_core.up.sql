...
-- given a DEFAULT of app.current_team_id() (so INSERTs auto-fill the current
...
-- applied fresh-install team set (51 tables), excluding schema_migrations
...
-- unset, app.current_team_id() raises rather than inserting a NULL/guessed team.
ALTER TABLE IF EXISTS public.bot_acl_rules ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_channel_admins ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_channel_configs ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_channel_routes ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_email_bindings ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_heartbeat_logs ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_history_message_assets ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_history_message_compacts ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_history_messages ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_plugin_installations ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_plugin_resources ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_session_discuss_cursors ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_session_events ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_sessions ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_storage_bindings ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_user_grants ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bot_workspace_resource_limits ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.bots ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.channel_identities ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.channel_link_codes ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.container_versions ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.containers ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.email_oauth_tokens ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.email_outbox ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.email_providers ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.fetch_providers ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.lifecycle_events ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.mcp_connections ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.mcp_oauth_tokens ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.media_assets ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.memory_edges ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.memory_nodes ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.memory_providers ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.model_variants ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.models ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.provider_oauth_tokens ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.providers ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.schedule ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.schedule_logs ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.search_providers ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.snapshots ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.storage_providers ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.tasks ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.tool_approval_requests ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.tts_models ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.tts_providers ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.user_channel_bindings ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.user_channel_identity_bindings ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.user_input_requests ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.user_provider_oauth_tokens ALTER COLUMN team_id SET DEFAULT app.current_team_id();
ALTER TABLE IF EXISTS public.users ALTER COLUMN team_id SET DEFAULT app.current_team_id();
           ...
           AND EXISTS (
               SELECT 1
                ...
                WHERE a.attrelid = c.oid
                  ...
                  AND pg_get_expr(d.adbin, d.adrelid) LIKE '%app.current_team_id()%'
           )
         ORDER BY c.relname
    LOOP
...
BEGIN
    ...
    LOOP
        ...
        EXECUTE format(
            'CREATE POLICY %I ON public.%I FOR SELECT USING (team_id = app.current_team_id())',
            tbl || '_team_select', tbl);

        EXECUTE format('DROP POLICY IF EXISTS %I ON public.%I', tbl || '_team_insert', tbl);
        EXECUTE format(
            'CREATE POLICY %I ON public.%I FOR INSERT WITH CHECK (team_id = app.current_team_id())',
        ...
        EXECUTE format(
            'CREATE POLICY %I ON public.%I FOR DELETE USING (team_id = app.current_team_id())',
...
CREATE POLICY teams_self_select ON public.teams
    FOR SELECT USING (id = app.current_team_id());
...
-- explicit app.current_team_id()), so a team_id-leading index lets the
