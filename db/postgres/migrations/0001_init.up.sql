...
-- Trigram substring search for project docs/issues (CJK-safe, unlike the
-- built-in tsvector parsers).
...
-- ---------------------------------------------------------------------------
-- Projects (0130): team-level collaboration spaces — Wiki doc tree + Issues
-- kanban sharing one node table. See 0130_projects.up.sql for design notes.
-- ---------------------------------------------------------------------------
