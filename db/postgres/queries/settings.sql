...
SELECT
  ...
  bots.network_provider,
  bots.network_enabled,
  bots.network_config
FROM bots
...
SELECT
  ...
  updated.network_provider,
  updated.network_enabled,
  updated.network_config
FROM updated
