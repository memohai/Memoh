...
SELECT count(*) FROM bot_heartbeat_logs WHERE team_id = app.current_team_id() AND bot_id = $1;

-- name: DeleteHeartbeatLogsByBot :exec
DELETE FROM bot_heartbeat_logs WHERE team_id = app.current_team_id() AND bot_id = $1;
