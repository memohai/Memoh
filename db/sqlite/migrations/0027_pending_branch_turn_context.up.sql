...
CREATE TABLE IF NOT EXISTS tool_approval_requests_0026_new (
  id TEXT PRIMARY KEY,
...
INSERT OR IGNORE INTO tool_approval_requests_0026_new (
...
ALTER TABLE tool_approval_requests_0026_new RENAME TO tool_approval_requests;
...
CREATE TABLE IF NOT EXISTS user_input_requests_0026_new (
  id TEXT PRIMARY KEY,
  bot_id TEXT NOT NULL REFERENCES bots(id) ON DELETE CASCADE,
  session_id TEXT NOT NULL REFERENCES bot_sessions(id) ON DELETE CASCADE,
  route_id TEXT REFERENCES bot_channel_routes(id) ON DELETE SET NULL,
...
INSERT OR IGNORE INTO user_input_requests_0026_new (
  id, bot_id, session_id, route_id, channel_identity_id, tool_call_id, tool_name,
...
ALTER TABLE user_input_requests_0026_new RENAME TO user_input_requests;
