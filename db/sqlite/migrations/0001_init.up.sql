...
CREATE TABLE IF NOT EXISTS providers (
  ...
  icon TEXT,
  enable INTEGER NOT NULL DEFAULT true,
  config TEXT NOT NULL DEFAULT '{}',
  metadata TEXT NOT NULL DEFAULT '{}',
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS search_providers (
  ...
  config TEXT NOT NULL DEFAULT '{}',
  enable INTEGER NOT NULL DEFAULT false,
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS bots (
  ...
  reasoning_enabled INTEGER NOT NULL DEFAULT false,
  ...
  heartbeat_enabled INTEGER NOT NULL DEFAULT false,
  ...
  compaction_enabled INTEGER NOT NULL DEFAULT false,
  ...
  persist_full_tool_results INTEGER NOT NULL DEFAULT false,
  show_tool_calls_in_im INTEGER NOT NULL DEFAULT false,
...
CREATE TABLE IF NOT EXISTS containers (
  ...
  auto_start INTEGER NOT NULL DEFAULT true,
